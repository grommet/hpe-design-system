...
2. Read the `ComponentDefinition` interface schema found in `knowledge/core/data/types.ts`.
...
8. Output the resulting YAML content so it can be saved as `knowledge/core/data/components/[component-name].yaml`.
...
- `knowledge/core/data/COMPONENT_EXAMPLE.yaml` (as a structural reference)
