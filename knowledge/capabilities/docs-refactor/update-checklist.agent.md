...
description: "Use when: marking a component as complete in the docs refactor plan after its PR is ready. Finds the component's entry in the Full Component Checklist in .github/docs-refactor-plan.md and changes '- [ ]' to '- [x]'. Part of the docs refactor workflow described in .github/docs-refactor-plan.md and .github/instructions/docs-refactor-execution.md."
...
2. **Read `.github/docs-refactor-plan.md`** and locate the component's entry in the Full Component Checklist. It will appear as one of:
...
5. **Confirm** — report the change:
   > "`[component-name]` marked complete in `.github/docs-refactor-plan.md`."
