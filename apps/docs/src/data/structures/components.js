...
export const components = [
  ...
  },
  {
    ...
    category: 'Controls',
    description:
      'Triggers an action or event, such as submitting a form, opening a dialog, confirming a decision, or navigating within a process step. Distinct from an anchor/link, which navigates to a new URL.',
    seoDescription:
