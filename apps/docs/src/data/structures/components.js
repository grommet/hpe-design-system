...
export const components = [
  ...
  },
  {
    ...
    category: 'Controls',
    description:
      'Triggers an action or event, such as submitting a form, opening a dialog, confirming a decision, or navigating within a process step.',
    seoDescription:
  ...
  },
  {
    ...
    category: 'Inputs',
    description:
      'Presents a single option or group of options that users can independently check or uncheck, including a toggle variant for switching between two mutually exclusive states.',
    seoDescription:
