...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/inline-notifications/InlineNotificationExample.js',
  ...
  github="https://github.com/grommet/hpe-design-system/blob/master/apps/docs/src/examples/templates/inline-notifications/InlineNotificationExample.js"
...
| ----- | ---------------------------- | ------------------------------------------------------------ | :------------------------------------------------------: | ---------------------------------------------------------------------------------------------------------------------- |
| **1** | **Icon or status indicator** | Indicates the status of notification                         | <span><Checkmark a11yTitle="true" size="small" /></span> | <span>Normal, Warning, Critical, and Unknown [status indicators](/templates/status-indicator) can be displayed.</span> |
...
| **3** | **Message**                  | Briefly describes the action, status, or additional context  | <span><Checkmark a11yTitle="true" size="small" /></span> | --                                                                                                                     |
...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/inline-notifications/StatusUpdateExample.js',
  ...
  github="https://github.com/grommet/hpe-design-system/blob/master/apps/docs/src/examples/templates/inline-notifications/StatusUpdateExample.js"
>
  <StatusUpdateExample />
</Example>
...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/inline-notifications/PageBannerExample.js',
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/Card/Card.js',
  ]}
  github="https://github.com/grommet/hpe-design-system/blob/master/apps/docs/src/examples/templates/inline-notifications/PageBannerExample.js"
  showResponsiveControls={['fullScreen']}
  screenContainer
  width="100%"
>
...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/inline-notifications/PromotionExample.js',
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/Card/Card.js',
  ]}
  github="https://github.com/grommet/hpe-design-system/blob/master/apps/docs/src/examples/templates/inline-notifications/PromotionExample.js"
  showResponsiveControls={['fullScreen']}
  screenContainer
  width="100%"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/inline-notifications/InlineFormValidation.js"
  github="https://github.com/grommet/hpe-design-system/blob/master/apps/docs/src/examples/templates/inline-notifications/InlineFormValidation.js"
>
  <FormValidation />
</Example>
