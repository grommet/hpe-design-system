...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/list-views/ListScreenExample.js',
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/list-views/ListNameDescriptionOptionExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/list-views/ListNameOptionActionExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/list-views/ListImageIdentifierExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/pagination/PaginationListExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/list-views/ListOrderExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
