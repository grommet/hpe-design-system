...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/feedback/SimpleFeedbackExample.js"
...
| ----- | ----------- | -------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1** | **Title**   | Title prompting user for their feedback.                                                                       | <span><Checkmark a11yTitle="true" size="small" /></span> | <span>Use the [semantically correct heading level](/foundation/typography?q=semantically#semantic-usage-of-heading-levels) for the title. "We'd love your feedback" is a nice, appreciative default title.</span>                                                                                                                                                                                                                                                     |
| **2** | **Body**    | The body may be populated with as many questions as appropriate.                                               | <span><Checkmark a11yTitle="true" size="small" /></span> | <span>Question types can include [StarRating](https://v2.grommet.io/starrating), [ThumbsRating](https://v2.grommet.io/thumbsrating), select all that apply (e.g. [CheckBoxGroup](https://design-system.hpe.design/components/checkboxgroup)), choose one (e.g. [RadioButtonGroup](https://design-system.hpe.design/components/radiobuttongroup)), open ended (e.g. [TextArea](https://design-system.hpe.design/components/textarea) or any other input types).</span> |
| **3** | **Footer ** | Contains two actions: "Submit" and "Dismiss" if used in Layer modal. Otherwise only "Submit" is needed inline. | <span><Checkmark a11yTitle="true" size="small" /></span> | Submit button sends survey responses to the HPE Customer Experience team and initiates thank you message. If presented in a modal, the Dismiss button allows the user to bypass the survey and continue their product experience.                                                                                                                                                                                                                                     |
...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/feedback/ModalTaskFlowExample/ModalTaskFlowExample.js',
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/feedback/ModalTaskFlowExample/PowerOnFlow.js',
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/feedback/ModalTaskFlowExample/TaskFlowFeedback.js',
  ...
  github="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/feedback/ModalTaskFlowExample/ModalTaskFlowExample.js"
