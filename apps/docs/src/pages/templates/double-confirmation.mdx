...
| ------ | ------------ | -------------------------------------------------------------------- | :-----------------------------------------: | ---------------------------------------------------------------------------------------------------------- |
| **1a** | **Title**    | Explains that data will be discarded when the user closes the layer. | <span><Checkmark a11yTitle="true" size="small" /></span> | --                                                                                                         |
| **1b** | **Subtitle** | To clarify that changes will not be saved.                           | <span><Checkmark a11yTitle="true" size="small" /></span> | --                                                                                                         |
| **2**  | **Footer**   | Contains two actions: "Cancel" and "Discard"                         | <span><Checkmark a11yTitle="true" size="small" /></span> | The actions should be right-aligned with primary action on the right, to align with center layer guidance. |
