...
<Example
  ...
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/page-layouts/PageContainerInteractive.js',
    ...
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/page-layouts/components/PageContainer.js',
  ]}
  github="https://github.com/grommet/hpe-design-system/blob/master/apps/docs/src/examples/templates/page-layouts/PageContainerInteractive.js"
  width="100%"
>
  <PageContainerInteractive />
</Example>
