...
<Example
  horizontalLayout
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/feat-2381-grid-docs/docs/src/examples/components/grid/UniformColumns.js"
  width={{ min: 'medium' }}
>
  <UniformColumns />
</Example>
...
<Example
  horizontalLayout
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/feat-2381-grid-docs/docs/src/examples/components/grid/MixedColumns1.js"
  width={{ min: 'medium' }}
  height="auto"
>
  <MixedColumns1 />
...
<Example
  horizontalLayout
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/feat-2381-grid-docs/docs/src/examples/components/grid/MixedColumns2.js"
  width={{ min: 'medium' }}
  height="auto"
>
  <MixedColumns2 />
...
<Example
  horizontalLayout
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/feat-2381-grid-docs/docs/src/examples/components/grid/MinMaxColumns1.js"
  width={{ min: 'medium' }}
  height="auto"
>
  <MinMaxColumns1 />
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/feat-2381-grid-docs/docs/src/examples/components/grid/MinMaxColumns2.js"
  width={{ min: 'medium' }}
  height="auto"
...
<Example
  horizontalLayout
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/feat-2381-grid-docs/docs/src/examples/components/grid/GapExample.js"
  width={{ min: 'medium' }}
  height="auto"
>
  <GapExample />
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/feat-2381-grid-docs/docs/src/examples/components/grid/FluidGrid1.js"
  width="100%"
  height="auto"
>
  <FluidGrid1 />
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/feat-2381-grid-docs/docs/src/examples/components/grid/FluidGrid2.js"
  width="100%"
  height="auto"
>
  <FluidGrid2 />
