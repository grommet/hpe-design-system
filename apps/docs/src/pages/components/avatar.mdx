...
Avatars can be displayed as an image, initials, or a logo. They come in five different sizes:
...
<Example
  ...
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/avatar/AvatarSizePreviewExample.js"
>
  <AvatarSizePreviewExample />
</Example>
...
<Example code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/avatar/AvatarDarkModeExample.js">
  <AvatarDarkModeExample />
</Example>

## Using color with initials

When an avatar shows initials, use an accent background. Accent backgrounds come
in `weak` and `strong` variants for each hue. See [color pairing](/foundation/color-pairing)
for full guidance on pairing text with weak and strong backgrounds.

Color is decorative here and should never be the only way a user identifies an
entity. Always pair the avatar with a name or other identifying text.

<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/avatar/AvatarColorExample.js"
>
  <AvatarColorExample />
</Example>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/avatar/AvatarPageHeaderExample.js"
  height="medium"
  pad="xsmall"
>
  <AvatarPageHeaderExample />
...
<Example
  horizontalLayout
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/avatar/AvatarAccessibilityExample.js"
  width={{ min: 'medium' }}
>
  <AvatarAccessibilityExample />
</Example>
