...
A standard dropdown menu displaying a clear list of actions.
    ...
    bestPractice={{
      ...
      message: (
        <Paragraph size="small" margin="none">
          Don't use menu to select a value. Use{' '}
...
<BestPracticeGroup>
  <Example
    bestPractice={{
      type: 'do',
      message:
        'Separate a dangerous action into its own group and place it at the end. Clicking on a dangerous action should lead to a double confirmation.',
    }}
  >
    {/* Box allows menu to be presented with drop open, overriding Example align/justify center */}
    <Box height="small">
...
<BestPracticeGroup>
  <Example
    bestPractice={{
      type: 'do',
      message:
        'Keep the number of items to a minimum. This allows the user to easily understand the scope of the actions they can perform.',
    }}
  >
    {/* Box allows menu to be presented with drop open, overriding Example align/justify center */}
    <Box height="medium">
