...
<br />
Keep in mind that a status **derives** from a state. The state of this task is successful,
therefore the status of the Toast notification is normal.
...
<Example
  componentName="Notification"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/templates/global-banner-notifications/Examples/ToastNotificationExample.js"
  docs="https://v2.grommet.io/notification"
  grommetSource="https://github.com/grommet/grommet/blob/master/src/js/components/Notification/Notification.js"
  height={{ min: 'small' }}
  width="100%"
