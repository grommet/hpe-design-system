...
<Example
  ...
  github="https://github.com/grommet/hpe-design-system/blob/master/shared/aries-core/src/js/components/layouts/DoubleConfirmation/DoubleConfirmationConfigurationForm.js"
  height={{ min: 'small' }}
  template
