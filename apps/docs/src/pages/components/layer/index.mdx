...
Use of a double confirmation may be desirable as part of the layer's closing behavior in some instances. See more detail about [when to use double confirmation](/templates/double-confirmation#use-cases).
