...
<Example
  ...
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/search/SearchExample.js"
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/search/ClearSearchExample.js"
  docs="https://v2.grommet.io/textinput?theme=hpe#props"
  width="medium"
  height="auto"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/search/SearchSuggestionsExample.js"
  docs="https://v2.grommet.io/textinput?theme=hpe#props"
  height={{ min: 'small' }}
  width="medium"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/search/SearchSimpleExample.js"
  docs="https://v2.grommet.io/textinput?theme=hpe#props"
  height={{ min: 'small' }}
  width="medium"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/docs/src/examples/components/search/SearchIconPositionExample.js"
  docs="https://v2.grommet.io/textinput?theme=hpe#props"
  height={{ min: 'small' }}
  width="medium"
>
