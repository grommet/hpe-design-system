...
import { Clock, Right } from '@hpe-design/icons-grommet';
...
<Example
  ...
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/templates/page-layouts/PageContainerInteractive.js',
    ...
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/templates/page-layouts/components/PageContainer.js',
  ]}
