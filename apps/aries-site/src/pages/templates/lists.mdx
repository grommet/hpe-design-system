...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/templates/list-views/ListScreenExample.js',
  ...
  figma="https://www.figma.com/design/HDckqS2MWhINfC8EIQPMV1/HPE-Design-System-Components-V2?m=auto&node-id=4553-538&t=9Kvc9d8gzK405Y1J-1"
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/templates/list-views/ListNameDescriptionOptionExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/templates/list-views/ListNameOptionActionExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/templates/list-views/ListImageIdentifierExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/components/pagination/PaginationListExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/templates/list-views/ListOrderExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
