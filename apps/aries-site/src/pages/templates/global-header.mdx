...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/templates/global-header/components/GlobalHeaderExample.js',
  ]}
  width="100%"
  screenContainer
>
