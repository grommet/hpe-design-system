...
<Example
  docs="https://v2.grommet.io/textinput?theme=hpe#props"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/components/textinput/TextInputPasswordExample.js"
  height={{ min: 'small' }}
>
  <TextInputPasswordExample />
</Example>
...
<Example
  docs="https://v2.grommet.io/textinput?theme=hpe#props"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/components/textinput/TextInputSuggestionsExample.js"
  height={{ min: 'small' }}
>
  <TextInputSuggestionsExample />
</Example>
...
<Example
  docs="https://v2.grommet.io/textinput?theme=hpe#props"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/components/textinput/TextInputLabeledByExample.js"
  height={{ min: 'small' }}
>
  <TextInputLabeledByExample />
</Example>
...
<Example
  docs="https://v2.grommet.io/textinput?theme=hpe#props"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/components/textinput/TextInputValidationExample.js"
  height={{ min: 'small' }}
>
  <TextInputValidationExample />
</Example>
...
<Example
  docs="https://v2.grommet.io/textinput?theme=hpe#props"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/components/textinput/TextInputDisabledExample.js"
  height={{ min: 'small' }}
>
  <TextInputDisabledExample />
</Example>
...
<Example
  docs="https://v2.grommet.io/textinput?theme=hpe#props"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/components/textinput/TextInputReadOnlyExample.js"
  height={{ min: 'small' }}
>
  <TextInputReadOnlyExample />
</Example>
