...
<Example
  docs="https://v2.grommet.io/footer?theme=hpe"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/components/footer/FooterPageExample.js"
  height={{ min: 'small' }}
  width="100%"
>
  <FooterPageExample />
...
<Example
  docs="https://v2.grommet.io/footer?theme=hpe"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/apps/aries-site/src/examples/components/footer/FooterComboExample.js"
  height={{ min: 'small' }}
  width="100%"
>
  <FooterComboExample />
