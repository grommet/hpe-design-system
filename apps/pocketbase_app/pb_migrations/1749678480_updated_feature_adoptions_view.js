...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("cpiedilw")

  // remove
  collection.schema.removeField("a8bjh0ny")

  // remove
  collection.schema.removeField("75ocbd2a")

  // remove
  collection.schema.removeField("azngrf1m")

  // remove
  collection.schema.removeField("wnedhvtu")

  // remove
  collection.schema.removeField("2pwhfy3m")

  // remove
  collection.schema.removeField("a2qbymlb")
