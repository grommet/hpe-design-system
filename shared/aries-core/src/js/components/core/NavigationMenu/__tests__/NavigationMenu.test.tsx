...
describe('NavigationMenu', () => {
  describe('Rendering', () => {
    it('should render custom header if provided', () => {
      ...
      expect(
        screen.queryByRole('heading', { name: /navigation menu/i }),
        ...
        const itemsWithUrlParent: NavItemType[] = [
          {
            label: 'Documentation',
            url: '/docs',
            children: [{ label: 'Get Started', url: '/docs/get-started' }],
          },
        ];

        const { rerender } = renderNavigationMenu({
    ...
    const groupedItems: NavItemType[] = [
      {
        ...
        children: [
          ...
          },
          {
            label: 'Controls',
            type: 'group',
            children: [{ label: 'Button', url: '/button' }],
          },
        ],
      },
    ];
