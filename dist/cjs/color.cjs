  ...
  "hpe": {
    "color": {
      ...
      "text": {
        ...
        "heading": "var(--hpe-color-text-heading)",
        "anchor": "var(--hpe-color-text-anchor)",
        "anchor-hover": "var(--hpe-color-text-anchor-hover)",
        "onSelectedPrimaryStrong": "var(--hpe-color-text-onSelectedPrimaryStrong)",
        "onSelectedPrimary": "var(--hpe-color-text-onSelectedPrimary)",
        "onStrong": "var(--hpe-color-text-onStrong)",
        "onCritical-strong": "var(--hpe-color-text-onCritical-strong)",
        "onCritical": "var(--hpe-color-text-onCritical)",
        "onInfo-strong": "var(--hpe-color-text-onInfo-strong)",
        "onInfo": "var(--hpe-color-text-onInfo)",
        "onOk-strong": "var(--hpe-color-text-onOk-strong)",
        "onOk": "var(--hpe-color-text-onOk)",
        "onUnknown-strong": "var(--hpe-color-text-onUnknown-strong)",
        "onUnknown": "var(--hpe-color-text-onUnknown)",
        "onWarning-strong": "var(--hpe-color-text-onWarning-strong)",
        "onWarning": "var(--hpe-color-text-onWarning)"
      },
      "icon": {
        ...
        "primary-hover": "var(--hpe-color-icon-primary-hover)",
