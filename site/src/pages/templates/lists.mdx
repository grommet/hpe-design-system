...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/list-views/ListScreenExample.js',
...
<Example
  background="background-back"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/list-views/ListNameDescriptionOptionExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
...
<Example
  background="background-back"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/list-views/ListNameOptionActionExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
...
<Example
  background="background-back"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/list-views/ListImageIdentifierExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/pagination/PaginationListExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
...
<Example
  background="background-back"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/list-views/ListOrderExample.js"
  docs="https://v2.grommet.io/list?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  width="100%"
>
