...
<Example
  ...
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/content-layouts/ResponsiveContentLayoutExample.js',
  ...
  github="https://github.com/grommet/hpe-design-system/blob/master/site/src/examples/templates/content-layouts/ResponsiveContentLayoutExample.js"
  height="650px"
  width="100%"
...
<Example
  showResponsiveControls={['fullScreen']}
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/content-layouts/ContainerDrivenLayout/ContainerDrivenLayout.js',
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/content-layouts/ContainerDrivenLayout/AppResults.js',
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/data/mockData/applications.json',
  ]}
  github="https://github.com/grommet/hpe-design-system/blob/master/site/src/examples/templates/content-layouts/ContainerDrivenLayout/ContainerDrivenLayout.js"
  height="650px"
  width="100%"
...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/content-layouts/ContentDrivenLayout.js',
  ...
  github="https://github.com/grommet/hpe-design-system/blob/master/site/src/examples/templates/content-layouts/ContentDrivenLayout.js"
  showResponsiveControls={['fullScreen']}
  screenContainer
  height="650px"
  width="100%"
...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/content-layouts/NestedGrid.js',
  ]}
  github="https://github.com/grommet/hpe-design-system/blob/master/site/src/examples/templates/content-layouts/NestedGrid.js"
