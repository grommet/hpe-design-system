...
import { Clock, Figma, Next } from 'grommet-icons';
...
<Example
  ...
  height={{ min: '625px' }}
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/page-layouts/PageContainerInteractive.js',
    ...
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/page-layouts/components/PageContainer.js',
  ]}
  github="https://github.com/grommet/hpe-design-system/blob/master/site/src/examples/templates/page-layouts/PageContainerInteractive.js"
  width="100%"
>
  <PageContainerInteractive />
</Example>
