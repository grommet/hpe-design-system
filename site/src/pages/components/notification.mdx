...
<Example
  ...
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/toast-notifications/ToastNotificationExample.js"
...
Global banner notifications are system-generated alerts that attract the user's attention to system conditions and updates. For more thorough guidance on how and when to properly make use of a global banner, access the full page on [Global Banner Notifications](/templates/global-banner-notifications).

<Example
  componentName="Notification"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/templates/global-banner-notifications/Examples/ToastNotificationExample.js"
  docs="https://v2.grommet.io/notification"
  grommetSource="https://github.com/grommet/grommet/blob/master/src/js/components/Notification/Notification.js"
  height={{ min: 'small' }}
  width="100%"
