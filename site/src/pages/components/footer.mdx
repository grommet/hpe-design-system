...
<Example
  ...
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/footer/FooterPageExample.js"
  height={{ min: 'small' }}
  width="100%"
>
  <FooterPageExample />
...
<Example
  docs="https://v2.grommet.io/footer?theme=hpe#props"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/footer/FooterComboExample.js"
  height={{ min: 'small' }}
  width="100%"
>
  <FooterComboExample />
