...
<ExampleImagePreview
  ...
  href="#searching-and-filtering-datatables"
...
<Example
  componentName="DataTable"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/datatable/DataTableEmptyCellExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  figma="https://www.figma.com/file/XEoIWIlLfcARRIFhkpFCch/HPE-Table-Component?node-id=195%3A0"
  grommetSource="https://github.com/grommet/grommet/blob/master/src/js/components/DataTable/DataTable.js"
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/datatable/DataTableSortable.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/datatable/DataTableResizeColumnsExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/datatable/DataTableSingleSelectExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/datatable/DataTableMultiSelectExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/pagination/PaginationTableExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
  height="auto"
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/pagination/PaginationServerTableExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
  height="auto"
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/datatable/DataTableFixedHeaderExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/datatable/DataTableSummaryExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/examples/components/datatable/DataTableVerticalListExample.js',
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/site/src/data/mockData/serverGroups.json',
  ]}
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  github="https://github.com/grommet/hpe-design-system/tree/master/site/src/examples/components/datatable"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
  <DataTableVerticalListExample />
