...
type ResponsiveBreakpointType = 'xsmall' | 'small' | 'medium' | 'large' | 'xlarge';
...
export const Collection = ({ ...rest }) => {
  ...
  const responsiveColumns = useMemo(() => {
    ...
    const nextColumns = tableColumns.filter(column => !exclude[cloudType]?.[breakpoint]?.includes(column.property));
    return nextColumns;
