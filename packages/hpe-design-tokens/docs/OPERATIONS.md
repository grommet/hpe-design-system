...
differ. The version and changelog update generated by the release workflow is exempt because it
consumes the pending Changeset and is created by GitHub Actions.
