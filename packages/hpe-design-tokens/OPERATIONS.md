...
`sync-rebind-figma-aliases` is deprecated and retained only for historical diagnostics. Prefer bootstrap plus key discovery and canonical subscriptions in normal workflows.
