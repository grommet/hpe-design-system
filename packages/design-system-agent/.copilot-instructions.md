...
- **No:** Monorepo support, non-React frameworks, non-Grommet libraries, CI/PR mode, Pattern audit scope
...
- **Comments:** Explain "why" not "what"; reference metrics or design decisions
