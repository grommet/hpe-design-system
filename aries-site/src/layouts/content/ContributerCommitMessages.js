...
//*****TRY/CATCH ATTEMPT FOR COMMITS AND PATCHES*****
...
//*****STANDARD FUNCTION ATTEMPT FOR COMMITS*****
// const contributorCommitMessages = function(topic, currentFileName){
//     console.log( `${topic}: ${currentFileName}` );
//     const [contrMsgs, setContributorMessages] = useState([]);
//     const [error, setError] = useState(null);
...
//*****THEN AND CATCH ATTEMPT FOR COMMITS*****
// const contributorCommitMessages = function(topic, currentFileName){
//     const [contrMsgs, setContributorMessages] = useState([]);
//     useEffect(() => {
//         fetch(`https://api.github.com/repos/grommet/hpe-design-system/commits?path=aries-site/src/pages/${topic}/${currentFileName}`, 
//                 { headers: {
...
//*****OCTOKIT ATTEMPT FOR PR'S*****
// import { Octokit } from "@octokit/rest";

// const octokit = new Octokit({
//     auth: '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',
// });

// const owner = 'grommet';
// const repo = 'hpe-design-system';
