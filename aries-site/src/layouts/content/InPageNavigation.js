    ...
    >
      ...
      <Nav gap="none" a11yTitle="Jump to section">
        {headings.map((heading, index) => {
          ...
          // activeHeading from context is in nameToSlug format
          const showActive = activeHeading === nameToSlug(headingTitle);

          const borderLeft = {
            side: 'left',
            size: showActive ? 'medium' : 'small',
            color: showActive ? 'border-strong' : 'border-weak',
          };
