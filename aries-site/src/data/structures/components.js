...
export const components = [
  ...
  },
  {
    ...
    tags: ['tiles', 'widgets', 'containers', 'cards', 'Card', 'Tile', 'Panel', 'Box', 'Module', 'Frame', 'Block', 'Snippet', 'Plate', 'Widget', 'Info Card',],
  },
  {
  ...
  },
  {
    ...
    tags: ['sections', 'containers', 'content containers', 'layout', 'flexbox',  'Box', 'Block', 'Section', 'Panel', 'Holder', 'Wrapper', 'Enclosure', 'Module', 'Compartment', 'Housing', 'Casing',],
  },
  {
    name: 'Grid',
    category: 'Layouts',
