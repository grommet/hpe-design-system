...
export const FoundationPreview = ({ size }) => (
  <svg
    style={{ position: 'absolute' }}
    width={size !== 'small' ? '65%' : '100%'}
    height={size !== 'small' ? '950' : '500'}
    viewBox={`${size !== 'small' ? '100' : '0'} 150 763 888`}
    fill="none"
  ...
  >
    <g opacity="0.9">
      <g filter="url(#filter0_d)">
        <rect
          ...
          height="360"
          rx="16"
          transform="rotate(8 58.1025 486)"
          fill="#F2F2F2"
        />
      </g>
    </g>
    ...
    <g opacity="0.8" filter="url(#filter2_d)">
      <rect
        ...
        height="360"
        rx="16"
        transform="rotate(8 353.103 312)"
        fill="#00C781"
      />
    </g>
    <g opacity="0.9">
      ...
      <rect
        ...
        height="20"
        rx="10"
        transform="rotate(8 534.124 250.589)"
        fill="#00C781"
      />
    </g>
    <defs>
