...
export const Meta = ({
  ...
  connect-src 'self' *.githubusercontent.com/grommet/hpe-design-system/ https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://www.github.com/grommet/ https://eyes.applitools.com *.hpe.com/hpe/api/ https://ca1.qualtrics.com/API/v3/surveys/ https://api.spacexdata.com/;
  media-src 'self' https://d3hq6blov2iije.cloudfront.net/media/;
  img-src 'self' data: https://*.google-analytics.com https://*.googletagmanager.com https://images.unsplash.com/ http://s.gravatar.com/avatar/ *.hpe.com/hfws-static/5/ https://d3hq6blov2iije.cloudfront.net/images/textures/ https://d3hq6blov2iije.cloudfront.net/images/gradients/ https://d3hq6blov2iije.cloudfront.net/images/hpe-greenlake/;
  script-src 'self' *.hpe.com https://www.google-analytics.com/analytics.js https://*.googletagmanager.com https://netlify-cdp-loader.netlify.app/netlify.js ${
