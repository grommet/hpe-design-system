...
export const Meta = ({
  ...
  img-src 'self' https://d3hq6blov2iije.cloudfront.net/images/ data: https://www.google-analytics.com https://images.unsplash.com/ http://s.gravatar.com/avatar/ *.hpe.com/hfws-static/5/;
