...
Radius tokens define the rounding of corners on elements. Radius can be used as a tool to further emphasize the shape or relationship between certain elements as well as reinforce page hierarchy.
