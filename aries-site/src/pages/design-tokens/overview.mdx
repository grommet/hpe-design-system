...
Design tokens codify the design decisions that make up a design system's visual style. Design tokens replace hard-coded values, such as hex codes for color or pixel values for spacing, with clear names.

Tokens can represent values such as colors, typography, spacing, motion and more.
...
To know more about token naming, visit [How to read tokens](tokens/how-to-read-tokens).
