...
A component should be styled based on the combination of what state the application has put it in and how the user is interacting with it. These states can be separated out into two types: interaction and application.
...
Some of application states correspond directly to CSS pseudo-classes (e.g., disabled), while others are named more generic to apply across components (e.g., “selected” can refer to a selected dropdown item or checked checkbox).

Application states that have use cases within the design system are represented in the table below.

## Supported states

In this table, “interaction” states are represented as column headings and “application” states are the rows. Green cells represent valid combinations.
