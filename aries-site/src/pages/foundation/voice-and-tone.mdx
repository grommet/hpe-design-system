...
If a sentence contains a list, do not allow the length of the list to be unbounded. Instead, consider a construct where three items are shown and the remaining items are grouped: _The following policies have not been implemented: Policy A, Policy B, Policy C, and 5 others._
