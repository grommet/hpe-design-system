...
- Respect the user and their time
    ...
    - Point the user directly to a resolution. Do not use "*contact your 
    administrator*" or "*contact HPE*" &mdash; the administrator is likely 
...
- Inspire trust and confidence
    ...
    - Avoid charged words such as "*error*"
