...
We can use a few simple tactics to create clarity: 

---

**Accessible**: Write with clear language to communicate clear ideas.
...
**Objective**: Anchor content in fact and objectivity, free of bias and judgement.
...
**Format**: Write content that complements its element in the user interface.
...
**Position**: Establish context with language that positions the user in the application: where they are and where they are going.
...
**Flow**: Write clear paths to goals and resolutions.
