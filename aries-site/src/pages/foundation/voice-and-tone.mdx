...
At HPE, almost all text should be written in sentence case. 
...
DO NOT USE ALL CAPS IN EITHER TITLES OR SENTENCES. It is equated with yelling and increases stress levels.
