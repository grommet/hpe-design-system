...
There are four types of capitalization. 
1. Sentence case, where the first letter is a capital, the second and all subsequent words begin with lowercase letters.
...
3. Camel case, where there are capital letters inside the word, almost always for branding purposes.
    (example: GreenLake)
4. All lower case, where every single word is lowercase 
