...
The HPE Design System employs text-based content that cultivates an exceptional user experience.
<!-- The above sentence will be the leading line and moved to the Voice and Tone card in Foundations once approved -->

Every word we write is a carefully-considered concept that voices our values: 
...
Refer to the guidance for [HPE's Voice]([https://brandcentral.hpe.com/brand-central/content/voice](https://brandcentral.hpe.com/brand-central/content/voice) for more information.

## Using Our Voice

Our voice is intrinsic to our content which is fundamental to the user experience. We exercise our voice through situational tones that speak to each context, audience, and subject matter. 

As our applications, so our content, we aim to be a force for good with messaging that is: 

- Active
- Positive
- Objective
- Plain English
- [Third-person point of view](#point-of-view)
