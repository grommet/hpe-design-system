...
A person's voice typically does not change once established. If our voice (HPE's voice) is inconsistent, people will notice. For example, as one notices the difference between writing academically when compared to sounding like a 5-year old. This kind of inconsistency can result in lack of trust.
...
- Branding can change over time. E.g. GreenLake Central has recently been rebranded to Cloud Services. If messages had contained `${prodname}`, this would have been an easy fix.
