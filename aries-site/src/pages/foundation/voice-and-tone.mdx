...
There are five main types of capitalization. 

"Title case," (also known as "initial caps") is where most letters are in capitals. Ex. the book title "The Catcher in the Rye."  

"Sentence case" is where only the first letter is capitalized and all the rest are lowercase.  

"All caps," which would LOOK LIKE THIS. 

"Lowercase," where all letters are "small," even the first letter. an example would be starting this sentence with a lowercase "a."

And then there's "Camel case," where a letter in the middle of a word is capitalized, such as in "GreenLake."  

Each capitalization style has its purpose and feeling it provokes in the user. All caps feels like "YELLING." Capitals, like in Title Case, attract the eye's attention and is used sparingly. All lowercase emits a highly informal feel. Meanwhile, for readability and calmer feel, sentence case is preferred by most writing style guides. HP Brand and HP Enterprise use sentence case in their writing style guides.  

Only these two types of text should be written in title case:

- Page and dialog titles
- Buttons

Almost all other text follows sentence case:
...
- Section (subsections) headings
- Legends
- Tabs

Fight the urge to elevate normal nouns to proper noun status. Proper nouns include peoples' names, city names, HPE copywrited products, etc. However, if you are on a "Data Sources" page and mention data sources, do not capitalize it. Only truly proper nouns, page ttles, and dialog titles are capitalized.
