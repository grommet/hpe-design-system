...
At HPE, almost all text should be written in sentence case. Never begin a sentence or phrase with a lower case letter (it is too casual for our brand) nor in all caps (it is equated with yelling and increases stress).
