...
export const globalCodeOptionsObjects = [
  {
    ...
    description:
      'Validating your HTML helps to provide a consistent, expected esperience across all browsers and assistive technologies.',
  ...
  },
  {
    ...
    description:
      'This allows assistive technologies such as screen readers to pronouce content correctly.',
  ...
  },
  {
    ...
    description:
      "The <title> element, found in the document's head element, is most often the first information announced by assistive technologies. A specifc and helpful <title> element will help users find content and orient themselves within it to begin navigating on the page.",
