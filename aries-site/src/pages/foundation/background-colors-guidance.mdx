...
- **background (dark) or another color (dark)** <ColorSwatch background={{color: "background", dark: true, sidebar: true}} /> - Used to indicate a [primary navigation sidebar](/templates/persistent-navigation) or [header](/components/header).
...
- **background (dark) or another color (dark)** <ColorSwatch background={{color: "background", dark: true, sidebar: true}} /> - Could be used to indicate a primary navigation sidebar or header.
