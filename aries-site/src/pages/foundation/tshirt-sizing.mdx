...
T-shirt sizing is the way that Grommet leverages familiar clothing sizes of "small", "medium", "large", and other ranges of sizes to drive the sizing and spacing of components. Grommet maps these t-shirt sizes to specific pixel values. The derivation of these pixel values will be explained more below.

T-shirt sizing controls two aspects of a UI: the width/height of components and the spacing within and around components (margin, pad, border, etc.)
