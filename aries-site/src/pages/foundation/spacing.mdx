import { Button, Notification, Paragraph } from 'grommet';
import { LinkNext } from '@hpe-design/icons-grommet';
import { ContentPane, BestPracticeGroup, Example } from '../../layouts';
import { SpacingBestPractices, SpacingScale } from '../../examples';
...
<figure style={{ display: 'contents' }}>
  <SpacingScale />
  <figcaption>Available spacing scale dimensions by t-shirt size</figcaption>
</figure>
...
<BestPracticeGroup>
  <Example
    ...
    bestPractice={{
      type: 'do',
      message:
        `Use spacing design tokens to style compositional or layout components 
