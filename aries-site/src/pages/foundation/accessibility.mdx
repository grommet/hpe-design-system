...
| **Content**                 |             |                      |                                   |
| Alt text & descriptions     | -         | Must provide descriptive alt text for images and media |
| Labeling                    | Forms, buttons, error messages, etc. | Must supply meaningful and descriptive labels |
| Readability                 | Provide examples, placeholder text, and documentation using plain, clear language | [Voice and Tone](https://design-system.hpe.design/foundation/voice-and-tone?q=voice) |
