...
- [WebAIM Introduction to Web Accessibility](https://webaim.org/intro/): An all-encompassing introducation to how accessibility can improve the web for all users.
- [The A11y Project Checklist](https://www.a11yproject.com/checklist/): A checklist that uses WCAG 2.1 as a reference for developers and designers to ensure their product's accessibility. 
