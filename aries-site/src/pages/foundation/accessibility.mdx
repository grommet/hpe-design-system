...
Everyone has the right to fully access and take advantage of the web. Accessibility covers a spectrum of disabilities including but not restricted to blindness, low vision, hearing and cognitive impairments and situational disabilities. From using glasses to aid with sight to a broken bone to carpal tunnel, about 25% of the population is experiencing a limited ability of some sort at any given time, permanent or not.
