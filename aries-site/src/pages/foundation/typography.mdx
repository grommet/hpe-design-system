...
The weights and styles shown are part of the HPE Design System theme. Graphik comes in a varity of weights. For digital experiences we use Light, Regular, Medium, Semibold and Bold weights at a variety of scales to compliment the content in a given design.
