...
The weights and styles shown are part of the HPE Design System theme. Graphik comes in a variety of weights. For digital experiences we use Light, Regular, Medium, Semibold and Bold weights at a variety of scales to compliment the content in a given design.
...
In most cases, teams should point to the web-hosted version of the Graphik fonts to ensure users always have the latest version.
...
In rare cases where a product needs to reference the Graphik fonts but users don't have internet access from their browser or maybe a designer needs the fonts locally, you can download the fonts for local use.

Graphik fonts can be downloaded from Brand Central in [OTF/Vector and Web](https://brandcentral.hpe.com/brand-central/content/typography) formats.
