...
<Button
  href="https://www.figma.com/design/oJhw3JqMemtbwWjlLPWW5O/HPE-Typography-Styles?m=auto&node-id=0-1&t=FGQxx1dTsnYSBi3K-1"
...
The weights and styles shown are part of the HPE Design System theme. MetricHPE comes in a varity of weights. For digital experiences we use Light, Regular, Medium, Semibold and Bold weights at a variety of scales to compliment the content in a given design.
...
In most cases, teams should point to the web-hosted version of the MetricHPE fonts to ensure users always have the latest version.
...
In rare cases where a product needs to reference the MetricHPE fonts but users don't have internet access from their browser or maybe a designer needs the fonts locally, you can download the fonts for local use.

MetricHPE fonts can be downloaded from Brand Central in [OTF/Vector and Web](https://brandcentral.hpe.com/brand-central/content/font#primary-external-font-metrichpe) formats.
