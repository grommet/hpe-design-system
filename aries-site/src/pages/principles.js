      ...
      <MainContent>
        <ContentSection>
          ...
          <Subsection>
            ...
            <Text>
              We are a company reborn, a new culture, and in a new space. We
              live in markets that ravenous and cutthroat when we are respectful
              and humane. We need more than technology to drive us. We need to
              embrace the discomfort and push to look at all avenues to stoke
              the fire for the next generation of tools—We must explore!
            </Text>
            <BulletedList
              items={[
                'Just start.',
          ...
          <Subsection>
            ...
            <Text>
              ...
              pursuit of solving the users needs—No, “One tool to rule them
              all!” mentality. Every interaction should ask if this is something
          ...
          <Subsection>
            ...
            <Text>
              ...
              ecosystem of HPE. Not all products have to look exact to garner
              the confidence of customers. It is important to check how it
              integrates and is consumed in conjunction with other services we
              provide.
            </Text>
            <BulletedList
              items={[
