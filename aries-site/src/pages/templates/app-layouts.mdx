...
--PRESENT-THE-FOLLOWING-AS-A-TABLE-OR-MAYBE-EVEN-A-NAMEVALUELIST--
...
### Breakpoints
A breakpoint is a width at which some change in the page design 
occurs. For designers, breakpoints can help stress test and 
