...
import { Figma, FormNext } from 'grommet-icons';
...
For guidelines and templates for Page Content, see [Content Layout](/templates/content-layout).

<Link href="/templates/content-layout" passHref>
  <Button 
    primary 
    label="See Content Layout Next" 
    icon={<FormNext />} 
    alignSelf="start" 
    reverse 
    size="large"
