...
template level, it can help with the layout of page sections. At a page section level, it can
...
Specifying layout content in this way will also ensure that it is interpreted
...
notice the content layout adjusts, ensuring content is ordered as desired across window
widths.
...
Additionally, a must-have tool for designers is [Layout Templates in Figma](https://www.figma.com/file/4rdBkUlHd5MCVq3hvUOXHd/Page-Layouts?node-id=2906%3A21283)
...
but can be useful for defining smaller subregions as well. The best use of available screen
