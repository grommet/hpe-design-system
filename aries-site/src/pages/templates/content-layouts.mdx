...
import { ContainerDrivenLayout, NumberColumns, ResponsiveContentLayoutExample } from '../../examples';
...
## Implementing Content Layouts with Grid
Grid's flexibility provides designers and developers great control and ability 
...
The following provides two approaches for building responsive content layouts with Grid.
...
which provide Grid-based layout templates for each responsive breakpoint and [page layout kind](/templates/page-layouts#page-kinds).
