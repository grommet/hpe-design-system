...
real-estate can be achieved by combining a container-driven page layout with things like Cards
which have been built to have adaptive layouts themselves.

The following example takes a container-driven approach, implementing a an app-catalog 
...
artificially constrained by its layout container.
