...
<Example 
  caption="Illustration showing how Lists can be used to navigate from the original List to a page of related content." 
  plain 
  pad="small" 
  previewWidth="large" 
  height={{ min: 'small' }}
...
<Example 
  caption="Illustrating showing how a user can click on the rows withing a DataTable that can take you to spokes as well as to hubs." 
  plain 
  pad="small" 
  previewWidth="large" 
  height={{ min: 'small' }}
