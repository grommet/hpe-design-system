...
<Example 
  caption="A diagram illustrating drill down navigation within Cards." 
  plain 
  pad="small" 
  previewWidth="large" 
  height={{ min: 'small' }}
...
<Example 
  caption="A diagram illustrating drill down navigation within Lists" 
  plain 
  pad="small" 
  previewWidth="large" 
  height={{ min: 'small' }}
...
<Example 
  caption="A diagram illustrating drill down navigation within a DataTable." 
  plain 
  pad="small" 
  previewWidth="large" 
  height={{ min: 'small' }}
