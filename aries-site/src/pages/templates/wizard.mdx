...
- Provide two buttons with a clear binary choice (Example: yes or no) and a secondary term that reaffirms the action (Example: stay or leave)
- The Primary Button should be used to confirm cancellation (Example: "Yes, Leave") and a Secondary Button should give the option to return back to completing the wizard (Example: "No, Stay").
