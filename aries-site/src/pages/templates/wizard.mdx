...
import { SimpleWizardExample, TwoColumnWizardExample } from '../../examples';
...
Use a wizard when your form involves multiple steps. This makes the experience more manageable for the user.
