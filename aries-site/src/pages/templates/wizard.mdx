...
1. **Wizard header**: This region contains the title of the wizard. The wizard header spans the full width of the viewport and is positioned within the scrollable region to scroll off as needed.
   - **a. Wizard title** (required): A short, descriptive title identifying the wizard.
   - **b. Contextual help button (optional).: A button offering the user contextual help. When clicked, a side drawer with relevant information will open. 
