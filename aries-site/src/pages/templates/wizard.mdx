...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/templates/wizard/SimpleWizardExample.js"
...
Validation should occur within each step of the wizard. If there are any errors with the inputs in the current step, the user should not be able to advance and errors should be displayed. Error display should follow conventions established by [Form](/templates/forms). See this behavior demonstrated in the [wizard with validation example](#with-validation).
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/templates/wizard/StickyHeaderFooterExample.js"
  screenContainer
  width="100%"
>
  <StickyHeaderFooterExample />
...
Validation should occur on each step. If a user has not properly completed a given step, they should not be able to advance to subsequent steps.
