...
| **5** | **Anchor**      | An additional learning cue to help the user out of the empty state. |                                             | If present, there is generally a single anchor, but an additional anchor can be added if the use case warrants. Limit to two or fewer.             |
