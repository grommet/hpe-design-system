...
All toasts have a fixed width size at Medium (384px) but the height can change based on the amount of content. 
...
- Starting deployment of application "XYZ"
- Created Kubernetes cluster "New York State Tax Authority"

**2. Interactive Content**

To remain compliant with WCAG 2.1 guidelines, avouid interactive elements, like links and buttons, inside of a toast. These elements may be difficult to access with a screen reader and other assistive technology.
