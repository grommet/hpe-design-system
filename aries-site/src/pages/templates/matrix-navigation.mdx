...
<Example 
  caption="Illustration showing how the user navigates within a global header." 
  plain 
  pad="small"
  previewWidth="large"
  height={{ min: 'small' }}
>
  <DiagramPreview 
    src={{
      dark: "/templateImages/Matrix-Global-Header-Invert.svg",
      light: '/templateImages/Matrix-Global-Header.svg'
    }} 
    alt="Diagram illustrating the matrix navigation within a global header." />
</Example>
