...
<Example caption="Diagram showing an in-app back button that provides the user with context around where they will return to after clicking the button." plain pad="small" previewWidth="large" height={{ min: 'small' }}>
