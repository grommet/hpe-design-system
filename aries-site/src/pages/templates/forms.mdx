...
- Use asterisks for required fields when the form has more than two required fields.
...
**Please note that at this time we do not have use cases that would be required to be labeled as optional. If you feel you have a use case that would need to be labeled as optional, please contact us to discuss further.**
