...
When using a mixture of required and optional fields, apply the "required" prop as well as an asterisk to any given FormField label in which will disable form submission until this field has been completed.
...
Info text is also relevant for fields such as password to show the user what password requirements are needed while they are filling out the form.
