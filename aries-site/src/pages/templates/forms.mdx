...
- Limit the number of optional fields as much as possible. Remember that the more fields you have on your form, the more you risk overwhelming the users.
...
Submit, reset, or cancel buttons should always be placed at the bottom of a Form and be left-aligned.
...
Users must actively check a box next to a statement that shows they're agreed to the Terms and Conditions when signing up for an account, and the legal agreement is a simple link in the text for easy access and quick reference.
