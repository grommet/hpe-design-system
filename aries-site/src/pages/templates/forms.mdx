...
- Limit the number of optional fields to as much as possible. Remember that the more fields you have on your form, the more you risk overwhelming the users.

<ExampleImagePreview
  label="Required and Optional Fields Example"
  src="/required&optional-Fields-example.png"
  href="/forms#required-and-optional-fields"
...
A login/registration form, which typically shows two to three required fields do not need to be annotated in any way - the form is short and the nescessity of completing the fields is relatively obvious.
