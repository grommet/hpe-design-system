...
- Use asterisks for required fields when the form has more than two required fields and/or has optional fields. See HPE UX research.  
...
- If absolutely necessary, include helpful text below the field, such as [password requirements](#sign-up) or [additional resources](#customize) on a field's context
...
- Restrict resource naming. Allow spaces, punctuation and unicode characters 
