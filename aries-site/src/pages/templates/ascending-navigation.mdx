...
```txt
<PageHeader 
  parent={ <Anchor label="Home" icon={<Left />} />} 
  title="Example page title" 
  subtitle="Im a direct child of the homepage"
/>
```
...
- Avoid using ascending navigation on top-level pages since there is no upstream destination.
