...
- **High attention information** &ndash; Consider using [Global notifications](/templates/global-banner-notifications)
  ...
  outage, critical error, or expiring subscription or license. [Global notifications](/templates/global-banner-notifications)
...
- Links may be used to provide additional information about the
...
- The width and resizing behavior of an inline notification should scale alongside
  ...
  PageHeader.
- Inline Notifications are not clickable. Instead use links to direct users to
