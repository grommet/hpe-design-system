...
import { InlineNotificationExample } from '../../examples';
...
such as status updates, alerts to success or failure of an action, or call
attention to a new feature in which a user may be interested.
...
<Example
  ...
  figma="https://www.figma.com/file/FGvOd2htjrChVVS2oz73ds/HPE-Notifications?node-id=1965%3A3844"
>
...
Consider using an inline notification when:
...
- **Status updates** &ndash; Delivering status updates about a task. For example,
  if a user initiated an ansynchronous process such as a device update, a
  notification might provide the status update upon. "Success - all devices have
...
| **2** | **Title**                    | Short, descriptive label identifying the notification        |                                             |                                                                                                                        |
