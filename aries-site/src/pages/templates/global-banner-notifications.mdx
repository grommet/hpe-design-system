...
### Things to Avoid
- Do not use `onClose` when information is important and needs to remain persistent. Also, consider whether or not the information should remain persistent across multiple sessions.
