...
For all products that exist within the GreenLake ecosystem, Global Header with the GreenLake badge should be used.

If a product does not exist within the GreenLake ecosystem, use the [HPE Common Header and Footer Web Service](#hpe-common-header-and-footer-web-service).
...
- Be distributed as a Web Component to allow it to easily be inserted into any product, regardless that product's use of React or not.
...
The HPE Common Header and Footer Web Service provides a tunable, yet consistent header and footer to be used across HPE
applications that exist outside of the GreenLake ecosystem. The header is provided as a service and injected into your
...
user such as GreenLake and other Cloud console applications as well as general
HPE links for HPE content like developer.hpe.com, education.hpe.com, etc. This
menu should be enabled to allow access to other HPE sites and applications.
