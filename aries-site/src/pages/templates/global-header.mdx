...
The *Shopping Cart* icon goes to the HPE shopping cart for buy.hpe.com. This should only
...
The country selector allows the user to go to a language-specific version of hpe.com. This
