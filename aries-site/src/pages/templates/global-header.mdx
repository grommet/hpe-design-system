...
<Notification 
  status="info" 
  message={`Please note that a new implementation of Global Header delivering 
  a variety of new features, including the new HPE GreenLake badge, is coming soon.`}
