...
Page margin is the left and right space between the main content of a page and the screen 
edge. Based on the screen size (not Page Kind), the page margin differs at each [responsive breakpoint](/templates/content-layouts#breakpoints).
...
Wider margins are better for larger screens, as they create more whitespace around the 
perimeter of the content. Smaller margins are appropriate for smaller screens, in order to 
maximize the available screen real estate.

| Breakpoint     |  Margin (pixels) |
| -------------- | -----------------:
| **xsmall**     | 12
| **small**      | 24
| **medium**     | 24
...
each [page content width's](/templates/page-layouts#page-container-widths) maximum width, 
