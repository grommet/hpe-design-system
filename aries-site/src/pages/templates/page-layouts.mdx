...
On desktop, the sidebar is fixed to the left side while header, main, and footer are a scrollable region. On mobile, the sidebar is fixed to the bottom of the screen. The border around page sections is for demonstration purposes only. Remove border in production.
...
On desktop, the sidebar is fixed to the left side while header and main are a scrollable region. On mobile, the sidebar is fixed to the bottom of the screen. The border around page sections is for demonstration purposes only. Remove border in production.
...
On both desktop and mobile, all content scrolls. The border around page sections is for demonstration purposes only. Remove border in production.
...
On both desktop and mobile, header is fixed to the top of the screen while main and footer are a scrollable region. The border around page sections is for demonstration purposes only. Remove border in production.
