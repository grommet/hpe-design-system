...
A "hub" cleanly presents multiple discreet application sections or "spokes." Each "spoke" keeps the user centered on a more focused task. A spoke should always provide navigation context back up the infomration hierarchy.
