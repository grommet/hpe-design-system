...
Applications often have scenarios where an object may have relationships to multiple 
child objects. Examples of this could be: 
...
See [managing child objects](/templates/forms/managing-child-objects) for presentation and 
behavioral details allowing a user to have easy access to a child object's details when needed, 
yet condensed when not.