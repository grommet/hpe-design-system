...
Results should live below the controls and display any records that meet filter criteria. Depending on the data types and use case, results may be represented by a [List](/templates/lists), [Cards](/components/card), or Table.
