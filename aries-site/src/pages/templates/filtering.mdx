...
- **If the filter set requires multiple selections can be made in a list that contains 5 or more items, use [SelectMultiple](/components/SelectMultiple).
- **When the data list contains 10 or more items, consider including search in your [SelectMultiple](/components/SelectMultiple) implementation.
