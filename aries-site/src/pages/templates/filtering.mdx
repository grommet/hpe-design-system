...
- **Is there only one item can be selected from a list?** use the [Select](/components/select) component.
...
- **If the data contains 10 or more items**, consider including search in your [SelectMultiple](/components/SelectMultiple) implementation.
