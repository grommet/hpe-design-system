...
Now we are able to display more products in each row, but they become too narrow for my
taste. Let's make our final modifications by importing the function `midSize` from a
