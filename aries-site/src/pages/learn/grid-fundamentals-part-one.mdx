...
At the end of this tutorial, you will have built [a grid of product cards](#final-layout).
...
```js
<Grid>
  <Box background={{color: "decorative-blue", opacity: 'weak'}} border pad="medium" align="center">
