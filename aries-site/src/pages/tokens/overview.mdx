...
Our tokens can be grouped into 3 categories: primitive, semantic, and component. The specificity of design tokens increases from primitive to semantic to component. This tiered system of tokens exists to enhance token consumption, management, and maintenance.
