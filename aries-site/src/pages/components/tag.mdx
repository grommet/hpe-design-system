...
### Managing metadata
Tags can be created, assigned and [removed](/components/tag#removable) from resources/items by a user.
...
### Static 
-  All points as above, but static tags are not interactive in any way.
