...
- A highlight tag used to indicate a temporary or transient state associated with an item (e.g. new, updated, promotional).
- A highlight tag draws attention but is no louder than a secondary or primary button.
