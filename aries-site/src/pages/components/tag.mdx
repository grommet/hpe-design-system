...
import { TagAnatomy, TagBasicAnatomy, TagResource, TagResourcePreview } from '../../examples';
...
<Example caption="Example showing a set of tags that might appear in a detail page."  horizontalLayout>
  <TagResourcePreview />
</Example>

**Scroll to the bottom of the below example to see the tag section within the context of a page.**

<Example showResponsiveControls={['laptop', 'mobile']} template>
  <TagResource />
</Example>
