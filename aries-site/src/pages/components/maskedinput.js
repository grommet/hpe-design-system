    ...
    <Layout title={title}>
      ...
      <ContentSection>
        <Subsection name={title} level={1} topic={topic}>
          ...
          <Example
            code="https://raw.githubusercontent.com/hpe-design/design-system/master/aries-site/src/examples/components/maskedinput/MaskedPhoneExample.js"
      ...
      <ContentSection>
        ...
        <Subsection name="Validation" level={3}>
          ...
          <Example
            docs="https://v2.grommet.io/maskedinput?theme=hpe#props"
            code="https://raw.githubusercontent.com/hpe-design/design-system/master/aries-site/src/examples/components/maskedinput/MaskedValidationExample.js"
            height={{ min: 'small' }}
          >
            <MaskedValidationExample />
          </Example>
