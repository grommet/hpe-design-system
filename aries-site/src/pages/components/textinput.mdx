...
<Example
  ...
  figma="https://www.figma.com/file/5uOrsL2qk8XwwH8C1ZpDb6/HPE-Design-System-Components?type=design&node-id=1249-23170&t=KjhQZHbAZR51Nmwu-11"
...
Used to indicate that a TextInput cannot be edited. When an input is readonly, it will receive tab focus and be submittied with form data.
