...
Global notifications are system-generated alerts that attract the user's attention to system conditions and updates. For more thorough guidance on how and when to properly make use of a global banner, access the full page on [Global Notifications](/templates/global-banner-notifications).
