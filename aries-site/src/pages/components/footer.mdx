...
The most common footer is an [App footer](#app-footer) which is contains legal and other important resources that pertain to the entirety of an application.
