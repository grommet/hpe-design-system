...
If a layer contains footer actions:

- The primary action should be labeled using verb + noun format (e.g., "Apply filters").
- The primary action verb should align with the layer title.
