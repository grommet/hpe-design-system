...
| ------ | ------------ | --------- | ------------------------------------------------------ | ------------------------------------------------------------------------- |
| **1**  | **Header**   | required  | Identifies the layer.                                  | --                                                                        |
| **1a** | **Title**    | required  | A short, descriptive title identifying the layer.      | Implemented as a Heading level 2, size="small".                           |
| **1b** | **Subtitle** | optional  | Any additional context or information about the layer. | --                                                                        |
| **2**  | **Body**     | optional  | Any additional content.                                | --                                                                        |
| **3**  | **Footer**   | optional  | Contains layer actions.                                | The ordering and aligment of footer actions depends on the type of layer. |
...
If the layer contains a form, the footer actions should be at the bottom of the form to encourage the user to see the entire form before submitting.
