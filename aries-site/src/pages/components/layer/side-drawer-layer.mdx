...
| ----- | ------------------------ | ----------------------------------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------- |
| **1** | **Close button**         | Closes the layer.                                                 | Required on layers with no footer actions. | --                                                                                                                                |
| **2** | **Footer actions**       | Provides actions for user to accept layer consequences or cancel. | Required on actionable layers.             | The actions should be left-aligned with primary action on the left. One action should be a "Cancel" button that closes the layer. |
