...
By default, 20 results per page are displayed. However, the default results per page should be context dependent. For example, log files per page might default to 50 or 100 results per page -- whereas documentation results might make more sense to default to 10 per page.

The examples on this page have been modified to show less results per page so that the pagination control is viewable in the single screen.
