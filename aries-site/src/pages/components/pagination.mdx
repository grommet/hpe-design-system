...
the full set of data. Breaking the data up into smaller, consistently sized groups, 
allow users to examine subsets or easily jump to specific sections of the data.
...
| **2** | **Pagination summary** | Context region displaying the range of results being viewed. Provides the user assurance by communicating the subset of results displayed. | Optional | |
