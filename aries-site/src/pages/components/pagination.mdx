...
Pagination is particularly effective for displaying large sets of results in components such as:
1. [Paginated Table](/components/table#paginated)
2. [Paginated List](/templates/lists#paginated)
3. [Paginated Cards](#paginated-cards)
