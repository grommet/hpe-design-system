...
Treat a Layer as a section of a page. Therefore, the first heading within a Layer should be a Heading with `level={2}`, and all subsequent headings should follow typical [semantic heading structure](/foundation/typography#semantic-usage-of-heading-levels).
