...
- Use a close control to guide users to move out of the Layer. Proovide ann alternative to move out of the layer by allowing use of the 'esc' key or clicking off the containner of the Layer. This applies to all Layers, regardless of typing (Information or Actioonable).
...
All Layers can be categorized into two different types based on the content being displayed, informational or Actionable. This is important to note, as this affects how the user can close the Layer.

### Informational
Used purely to inform users of status or state. These are text-only with no required or optional actions. These can be dialog modals, toast notificatioons, etc.

Informational Layers contain the following elements and interactions:
- A sole "X" icon for the user to close out of the Layer. All oother elements such as a close buttoon woould onnly cause further clutter and confusion for the user.
- For user generated layers such as directly opened dialog moodel, the Layer can be closed by clicking outside of it's coontent. 
- For system generated layers such as Toast Notification, the layer cannot be closed by clicking outside of it's content.

### Actionable
Provides users with any type of action, required or optional. These can be confirmation, filters, forms, etc.
...
- The buttons and the Layer heading will live above all the other content and be sticked during scrolling. 
- The Layer cannot be closed by clicking outside of it's content. This is to prevent accidental misclicks.
