...
- Provide an alternative to move out of the layer by allowing use of the 'esc' key or clicking off the container of the Layer. This applies to all Layers, regardless of type (e.g. [informational](/components/layer#informational) or [actionable](/components/layer#actionable)).
