...
- The Layer header should be sticky while the rest of the Layer content is scrollable. This can either be achieved with a [persistent sticky header]() or a [header that is sticky when the user scrolls up](). 
