...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/components/datatable/DataTableStatusStateExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
>
  <DataTableStatusStateExample />
...
<Example
  ...
  showResponsiveControls={['laptop', 'mobile']}
>
  <DataTableStatusOnlyExample clickable={false} />
</Example>
