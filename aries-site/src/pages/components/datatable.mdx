...
### Vertical lists within DataTables
A DataTable row could have a vertical list as a data entry. 
TODO: Example code snippet currently shows 404 (new .js file not yet merged to master).
TODO: Add more written guidance for vertical list behavior/functionality.
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/components/datatable/DataTableVerticalListExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  showResponsiveControls={['laptop', 'mobile']}
  template
>
