...
- [Combined column for Status and State](#2-combined-column-for-status-and-state)
- [Only Status column](#3-only-status-column)
...
#### 2. Combined column for Status and State
