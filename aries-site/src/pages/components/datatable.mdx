...
<Box width="large">
  <Image src="/static/images/datatable-only-status-column.svg" alt="Example showing a status column in the data table pointing to the state within the details" />
</Box>
