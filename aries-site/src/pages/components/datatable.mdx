...
<Anchor label="Learn more about providing a great filter experience"
...
#### Options to enhance browsing experince
...
- Use infinite scroll when supporting exploratory browsing. 
  It reduces friction and allows users to move through large sets of 
  records without interrupting their scanning flow.
