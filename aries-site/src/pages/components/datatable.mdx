...
filter controls enable progressive narrowing of the DataTable’s results.
...
- Make columns sortable to allow users to order records by value, 
  helping them more easily compare data and identify patterns, 
  outliers, or priority items.
- Use meaningful column data types—such as status indicators, 
