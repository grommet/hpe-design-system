...
<BestPracticeGroup>
  <Example
    ...
    bestPractice={{
      type: 'do',
      message: 'Style filter buttons as default buttons.',
    }}
    scale={0.4}
    width="100%"
  >
  ...
  <Example
    ...
    bestPractice={{
      type: 'dont',
      message: `Don’t use a Card to wrap a set of buttons. Cards should act as independent regions that do not affect surrounding content.`,
    }}
    scale={0.4}
    width="100%"
  >
