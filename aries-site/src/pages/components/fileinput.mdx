...
If you need to display the full name of uploaded files instead of the default truncated filenames, you can use the `renderFile` prop. For more information, visit [the official documentation](https://v2.grommet.io/fileinput#renderFile).
