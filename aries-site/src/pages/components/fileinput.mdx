...
**Filename truncation:**
At the moment, we are recommending that implementers use the [renderFile prop](https://v2.grommet.io/fileinput#renderFile) to display the full file name in cases where truncation occurs and the full name needs to be visible.
