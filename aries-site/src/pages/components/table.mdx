...
**Table header**<br />
Contain table header cells which concisely label the column's contents.
Column headers may be enhanced by enabling [sorting](#sorting).

**Table body**<br />
Consists of rows which allow users scan, read and take action on the data. 
...
<Example
  code="https://raw.githubusercontent.com/hpe-design/design-system/master/aries-site/src/examples/components/table/TableSortable.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  height={{ min: 'small' }}
>
  <TableSortable />
...
<Example
  code="https://raw.githubusercontent.com/hpe-design/design-system/master/aries-site/src/examples/components/table/TableSingleSelectExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  height={{ min: 'small' }}
>
  <TableSingleSelectExample />
...
<Example
  code="https://raw.githubusercontent.com/hpe-design/design-system/master/aries-site/src/examples/components/table/TableSummaryExample.js"
  docs="https://v2.grommet.io/datatable?theme=hpe#props"
  height={{ min: 'small' }}
>
  <TableSummaryExample />
