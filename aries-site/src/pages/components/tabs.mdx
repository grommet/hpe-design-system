...
Apply `justify="start"` to the Tabs so the tab controls align to the start of their container and the bottom border extends the full-width of the parent container.
