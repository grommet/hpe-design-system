...
- Clicking on the previous and next arrows will show additional tabs. On a small screen the arrows will show 1 additional tab. On medium or large screens, clicking the arrows will show 3 additional tabs.

<Example
  docs="https://v2.grommet.io/tabs?theme=hpe#props"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/components/tabs/TabResponsiveExample.js"
  height={{ min: 'small' }}
  width="100%"
>
  <TabResponsiveExample />
