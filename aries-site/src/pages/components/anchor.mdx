...
<BestPracticeGroup>
  <Example
    height="none"
    bestPractice={{type: 'do', message: 'Use label text that is descriptive about where the anchor will lead the user.'}}
  >
    <AnchorGoodExample />
  </Example>
  <Example
    height="none"
    bestPractice={{type: 'dont', message: `Use vague text like "Click here" because it doesn't provide meaning to users that rely on screen readers.`}}
  >
    <AnchorBadExample />
  </Example>
</BestPracticeGroup>
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/components/anchor/AnchorWeightExample.js"
  docs="https://v2.grommet.io/anchor?theme=hpe#props"
>
  <AnchorWeightExample />
</Example>
