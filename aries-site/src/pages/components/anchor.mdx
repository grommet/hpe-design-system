...
<BestPracticeGroup>
  <Example  height="none" bestPractice={{type: 'do', message: 'Use label text that is descriptive about where the anchor will lead the user.'}}>
    <AnchorExample />
  </Example>
  <Example
    height="none"
    bestPractice={{type: 'dont', message: `Don't use vague text like "Click here".`}}
  >
    <AnchorExample />
  </Example>
</BestPracticeGroup>
