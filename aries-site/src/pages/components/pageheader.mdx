...
<BestPracticeGroup>
  ...
  <Example
    bestPractice={{
      type: 'dont',
      message: `Don't clutter the Page Header with all of the page metadata. Instead, include this as a NameValueList in the page content.`,
    }}
    width="100%"
    height={{ min: 'small' }}
  >
...
<BestPracticeGroup columns="100%">
  <Example
    bestPractice={{
      type: 'do',
      message: 'Collapse default and secondary buttons into an action menu.',
    }}
    width="100%"
    height={{ min: 'small' }}
  >
