...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/components/pageheader/ChildPageHeaderExample.js"
  docs="https://v2.grommet.io/pageheader?theme=hpe"
...
- If there is a primary action, then all actions should appear beneath the title and subtitle and be left-aligned with page content.
