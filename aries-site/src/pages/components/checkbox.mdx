...
When using CheckBox outside of Formfield, it does not have a border or label. The hover indentifier will also be on the CheckBox itself.
Here are some common use cases for when a CheckBox can be used outside of a FormField:
...
2. There is no additional information or help text necessary for the user to understand what is being asked of them.
