...
By default, CheckBox has built-in `pad` to create space between a CheckBox and FormField border. When using CheckBox outside of a FormField, apply `pad="none"`.
