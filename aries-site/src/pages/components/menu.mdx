...
| **3** | **Menu item**       | Represents an individual action within the menu.                                   | Required | Items should be organized logically (see [Organizing Menu Items](#organizing-menu-items)).                                                |
