...
**TODO: Add Do / Don't here showing how to treat menus with small number of items (where separator isn't necessary)**

<BestPracticeGroup>
  <Example 
    bestPractice={{
      type: 'do', 
      message: 'ADFKJASLJFASJFASF Akdfja;las ffdjalsdfj.'
    }}
  >
    <MenuGroupingExample />
  </Example>
...
**TODO: Add Do/Dont example of dangerous action separated vs not separated and leading to a double confirmation experience**
...
#### Batch actions menu related to a selection of devices
<Example>
  <MenuBatchActionsExample />
</Example>
