...
| :---: | ------------------- | ---------------------------------------------------------------------------------- | :------: | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **1** | **Menu Button**     | Opens the menu when clicked.                                                       | Required | Can include a label, icon, or both.                                                                                                        |
...
| **2** | **Drop container**  | Holds and displays the list of menu items when the menu is expanded.              | Required | --                                                                                                                                         |
| **3** | **Menu item**       | Represents an individual action within the menu.                                   | Required | <span style={{ display: 'inline' }}>Items should be organized logically (see [Organizing Menu Items](#organizing-menu-items)).</span>        |
| **3a** | **Item label**     | Communicates the specific action to the user.                                      | Required | --                                                                                                                                         |
...
<BestPracticeGroup>
  <Example
    bestPractice={{
      type: 'do',
      message: 'Use menu to display actions.',
    }}
  >
  ...
  <Example
    bestPractice={{
      type: 'dont',
      message: <Paragraph size='small' margin="none">Don't use menu to select a value. Use <Anchor label='Select' href="/components/select"/> instead.</Paragraph>,
    }}
  >
    {/* Box allows menu to be presented with drop open, overriding Example align/justify center */}
    <Box height="small">
...
<BestPracticeGroup>
  <Example
    bestPractice={{
      type: 'do',
      message: 'Use dividers to organize groups.',
    }}
  >
    {/* Box allows menu to be presented with drop open, overriding Example align/justify center */}
    <Box height="small">
  ...
  <Example
    bestPractice={{
      type: 'dont',
      message: `Don't use dividers as individual item separators.`,
    }}
  >
    {/* Box allows menu to be presented with drop open, overriding Example align/justify center */}
    <Box height="small">
      <MenuDividersExample bestPractice={false} />
    </Box>
  </Example>
</BestPracticeGroup>
...
<BestPracticeGroup>
  <Example
    bestPractice={{
      type: 'do',
      message: 'Keep the number of items to a minimum. This allows the user to easily understand the scope of the actions they can perform.',
    }}
  >
    {/* Box allows menu to be presented with drop open, overriding Example align/justify center */}
    <Box height="small">
  ...
  <Example
    bestPractice={{
      type: 'caution',
      message: `Avoid adding too many options under one menu. This can make the actions hard to scan.`,
    }}
  >
    {/* Box allows menu to be presented with drop open, overriding Example align/justify center */}
    <Box height="small">
