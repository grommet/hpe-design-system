...
<BestPracticeGroup>
  ...
  <Example
    bestPractice={{
      type: 'dont',
      message: `Don't add a separator between groups when there is only 1 menu item in each category.`,
    }}
  >
...
<BestPracticeGroup>
  ...
  <Example
    bestPractice={{
      type: 'dont',
      message: `Don't leave dangerous actions grouped with other actions.`,
    }}
  >
...
TODO: add a series of examples showcasing tangible resources (e.g. servers, clusters, etc.)

#### Batch actions menu related to a selection of servers

<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/components/menu/MenuBatchActionsExample.js"
  docs="https://v2.grommet.io/menu?theme=hpe#props"
  height={{ min: 'small' }}
>
  <MenuBatchActionsExample />
...
<Example
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/components/menu/MenuRecordActionsExample.js"
  docs="https://v2.grommet.io/menu?theme=hpe#props"
  height={{ min: 'small' }}
>
  <MenuRecordActionsExample />
