import { CompareUseCases, Example } from '../../layouts';
import {
  ButtonExample,
  ButtonIconExample,
  ButtonStatesExample,
...
<CompareUseCases 
    imageSrcGood="/static/images/button_use_case_1.svg"
    imageAltGood="Image of sign up form with full width call to action"
    captionGood="Full width CTAs help users identify & interact with buttons easier on smaller browser widths and when using the press gesture."
    imageSrcBad="/static/images/button_use_case_2.svg"
    imageAltBad="Image of sign up form with small width call to action"
    captionBad="Making the CTA smaller here lessens it’s visual impact and makes it more difficult for the user to interact with it on smaller browser widths."
/>
<CompareUseCases 
    imageSrcGood="/static/images/button_use_case_3.svg"
    imageAltGood="Image of card with small width secondary button"
    captionGood="This secondary button is not a CTA more subtly presents itself on the page."
    imageSrcBad="/static/images/button_use_case_4.svg"
    imageAltBad="Image of card with full width secondary button"
    captionBad="This secondary button draws unnecessary attention to itself and confuses the visual heirarchy of the page."
/>
...
<CompareUseCases 
    imageSrcGood="/static/images/button_use_case_5.svg"
    imageAltGood="Image of a button row"
    captionGood="These buttons are appropriately displayed in-line as the full button content is clearly visible."
    imageSrcBad="/static/images/button_use_case_6.svg"
    imageAltBad="Image of a button row with truncated labels"
    captionBad="The label text is truncated, making these buttons unreadable."
/>
<CompareUseCases 
    imageSrcGood="/static/images/button_use_case_7.svg"
    imageAltGood="Image of a button row stacked vertically"
    captionGood="Because of the long labels, these buttons have switched to a vertical arrangement."
    imageSrcBad="/static/images/button_use_case_8.svg"
    imageAltBad="Image of a button row stacked vertical with word wrapped labels"
    captionBad="The labels required a line-break and negatively impact the readability of the buttons."
/>