...
The badge prop adds a small indicator to a Button to show extra information, like a notification or message count. You can use it in a few different ways depending on what you want to communicate:

- If you just want to show something is new or needs attention, you can use a simple dot by setting badge to true.
- If you want to show how many items there are — like 3 new messages — you can pass a number, and the badge will display it.
- For large numbers, you can use an object with a value and a max. If the value goes over the max, the badge will show something like 99+, keeping things tidy and easy to read.
