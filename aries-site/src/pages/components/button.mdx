...
When buttons are “Brand” or “Call to Action (CTA)”, it is best to have them fill the full width of the container for browser widths of "small". Because press target size and an unclear visual hierarchy are key concerns here, this utilizes available space to ensure users can easily identify and interact with important buttons.
