...
<Box border="#d4d8db" round="small" width={{ max: '100%' }} overflow="hidden">
  <iframe
    src="https://68a37e6158d976c56631627e-pzjoqdiisd.chromatic.com/?path=/story/anchorexample--anchor-example&panelPosition=right&globals=backgrounds.value:dark&singleStory=true&viewMode=story"
    height="400"
    frameBorder="0"
  ></iframe>
</Box>
