...
<Example
  ...
  figma="https://www.figma.com/file/5uOrsL2qk8XwwH8C1ZpDb6/HPE-Design-System-Components?type=design&node-id=4489%3A78687&t=DP7y1R7cWPyxjA2g-1"
...
#### Guidance on when to use 'add', 'create' and 'new'.

**Add**: ‘Add’ should be used where someone can add something that is already existing. It’s recommended to include the name of the thing that user can create. Combine add with the object where appropriate, Add+thing to create. 
Examples: Add user, Add file, or Add member. 

**New**: Use ‘New’ for creating something new, a new object. Include the name of the thing that user can create.
Use ‘New’ to initiate the action. 
Examples: New account, New file or New tab.

**Create**: ‘Create’ should be used where the user wants to create something that needs to be produced from the scratch, from nothing. Create requires users to include details as part of the create process. Create can be used for submit button of a form.  
Example: Create a design, Create a project, or Create volume. 
...
<Example previewWidth="large" height="none" pad="small" width="large">
  <ButtonLeftAlignExample />
</Example>
...
If you have questions about your use case, feel free to reach out in the #hpe-design-system channel on [Grommet Slack](https://grommet.slack.com).
...
CTA buttons should be used whenever a prospect or customer is unlocking new value from HPE’s edge-to-cloud promise. Read [when to use a CTA button](/components/button?q=butt#when-to-use-a-cta-button) for detailed guidance on usage.

<Example
  componentName="Button"
  code="https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/components/button/CTAButtonExample.js"
  designer="https://designer.grommet.io/button?id=HPE-design-system-hpedesignsystem-hpe-com&mode=edit"
  docs="https://v2.grommet.io/button?theme=hpe#props"
  figma="https://www.figma.com/file/5uOrsL2qk8XwwH8C1ZpDb6/HPE-Design-System-Components?type=design&node-id=4489%3A78687&t=yv7DUusmUWV5I7hQ-1"
  grommetSource="https://github.com/grommet/grommet/blob/master/src/js/components/Button/Button.js"
  height={{ min: 'small' }}
>
  <CTAButtonExample />
...
<Example
  code={[
    'https://raw.githubusercontent.com/grommet/hpe-design-system/master/aries-site/src/examples/components/button/ButtonBusyExample.js',
