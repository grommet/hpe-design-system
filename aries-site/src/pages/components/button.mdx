...
- For large numbers, an object with value and max can be used. If the value exceeds the max, the badge will display something like 99+, keeping the visual presentation clean and readable.
