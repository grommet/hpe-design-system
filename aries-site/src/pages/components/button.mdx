...
Specifically, CTA Buttons should be used whenever a prospect or customer is unlocking new value from HPE’s edge-to-cloud promise. This primarily occurs in marketing contexts, but can also occur within an enterprise application where a service, feature, trial opportunity, or event is being promoted.
