...
Specifically, CTA Buttons should be used whenever a prospect or customer is unlocking new value from HPE’s edge-to-cloud promise. This occurs in marketing contexts such as:
