...
Using the design system Button Component will ensure your button looks like a button. Applying the appropriate label is also important in making sure the user has a clear understanding of what the action will do.
...
- A CTA button may not always be the best element to use. If there is not a need to highlight an action, it is appropriate to use other controls.
...
Primary action buttons are used within enterprise applications. They are meant to assist, as opposed to entice, and are designed to maximize a user’s experience by highlighting the most common or important action on a page and allowing the user to accomplish a goal or task.
