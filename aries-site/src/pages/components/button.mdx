...
Toggle buttons are used either to switch between two states, such as check and unchecked, or to trigger two actions like on or off.

#### Toggle Buttons with Icons

Icon buttons have an aria-label that will describe the action that the user will be performing when using screen readers.

**Best Practices:**
- Don’t use more than 2-3 words
- Use verbs first to describe the action such as “Toggle” , “Favorite” or “Save”
- Use sentece case capitalization
- It is recommended that words such as “the”, “a” be avoided

For Buttons with Icons ONLY, it is important that you show the two following elements:

1. Show the current state of the button through the use of an icon that best represents the action

2. Inform the user of what is going to happen next by including a11y text and or changing the label

#### Where to use Toggle Buttons

- Add checkboxes in forms
- Play/pause a video
- Like/dislike a comment
- Favorite/unfavorite an image
- To show the visibility of an asset or a collection such as that in an accordion
- To select an option among many options like in a toggle button
